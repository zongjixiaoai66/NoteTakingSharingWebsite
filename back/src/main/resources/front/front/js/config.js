...
var centerMenu = [
    ...
    ,{
        name: '笔记收藏',
        url: '../bijiCollection/list.html'
    }
    ,{
        name: '笔记留言',
        url: '../bijiLiuyan/list2.html'
    }
    ,{
        name: '我的关注',
        url: '../guanzhu/list.html'
    }
    ,{
        name: '日常任务',
        url: '../richangrenwu/list.html'
    }
    ,{
        name: '领取任务',
        url: '../richangrenwuLingqu/list.html'
    }
    ,{
        name: '商品收藏',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/biji/admin/dist/index.html#/login";
