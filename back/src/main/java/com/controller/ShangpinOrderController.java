...
//                            shangpinOrderEntity.setShangpinOrderTruePrice(data.get(0));                    //花费积分 要改的
    ...
    */
    ...
    public R add(@RequestBody ShangpinOrderEntity shangpinOrder, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,shangpinOrder:{}",this.getClass().getName(),shangpinOrder.toString());
            ...
            if(balance<0)
                return R.error(511,"积分不够支付");
            shangpinOrder.setShangpinOrderTypes(101); //设置订单状态为已兑换
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for (Map<String, Object> map : shangpins) {
           //取值
            ...
            shangpinOrderEntity.setBuyNumber(buyNumber);//兑换数量 ？？？？？？
    ...
    */
    ...
    public R refund(Integer id, HttpServletRequest request){
        ...
        String role = String.valueOf(request.getSession().getAttribute("role"));
            ...
            shangpinOrder.setShangpinOrderTypes(102);//设置订单状态为已取消兑换
