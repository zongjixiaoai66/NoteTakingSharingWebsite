...
public class BijiLiuyanView extends BijiLiuyanEntity implements Serializable {
	...
	public BijiLiuyanView() {

	}

	public BijiLiuyanView(BijiLiuyanEntity bijiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, bijiLiuyanEntity);
