...
*/
@TableName("guanzhu")
public class GuanzhuView extends GuanzhuEntity implements Serializable {
	...
	public GuanzhuView(GuanzhuEntity guanzhuEntity) {
		try {
			BeanUtils.copyProperties(this, guanzhuEntity);
