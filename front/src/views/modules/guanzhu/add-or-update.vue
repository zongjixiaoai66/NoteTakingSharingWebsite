    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="关注编号" prop="guanzhuUuidNumber">
                       <el-input v-model="ruleForm.guanzhuUuidNumber"
                                 placeholder="关注编号" clearable  :readonly="ro.guanzhuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="关注编号" prop="guanzhuUuidNumber">
                           <el-input v-model="ruleForm.guanzhuUuidNumber"
                                     placeholder="关注编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="关注人" prop="guanzhuKucunNumber">
                       <el-input v-model="ruleForm.guanzhuKucunNumber"
                                 placeholder="关注人" clearable  :readonly="ro.guanzhuKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="关注人" prop="guanzhuKucunNumber">
                           <el-input v-model="ruleForm.guanzhuKucunNumber"
                                     placeholder="关注人" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    guanzhuUuidNumber: true,
                    guanzhuKucunNumber: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    guanzhuUuidNumber: new Date().getTime(),
                    guanzhuKucunNumber: '',
                    insertTime: '',
                },
                yonghuOptions : [],
                rules: {
                   ...
                   guanzhuUuidNumber: [
                              { required: true, message: '关注编号不能为空', trigger: 'blur' },
                          ],
                   guanzhuKucunNumber: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`guanzhu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.guanzhuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
