    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="花费积分" prop="shangpinOrderTruePrice">
                       <el-input v-model="ruleForm.shangpinOrderTruePrice"
                                 placeholder="花费积分" clearable  :readonly="ro.shangpinOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="花费积分" prop="shangpinOrderTruePrice">
                           <el-input v-model="ruleForm.shangpinOrderTruePrice"
                                     placeholder="花费积分" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinOrderTruePrice: [
                              { required: true, message: '花费积分不能为空', trigger: 'blur' },
