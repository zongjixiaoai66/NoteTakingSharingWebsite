    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="所需积分" prop="shangpinNewMoney">
                       <el-input v-model="ruleForm.shangpinNewMoney"
                                 placeholder="所需积分" clearable  :readonly="ro.shangpinNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="所需积分" prop="shangpinNewMoney">
                           <el-input v-model="ruleForm.shangpinNewMoney"
