    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">笔记记录分享网站注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <!--
                            <el-form-item label="用户介绍" class="input" v-if="tableName=='yonghu'">
                                <el-input type="textarea" v-model="ruleForm.yonghuContent" placeholder="用户介绍"></el-input>
                           </el-form-item>
                        -->
                       <!--<el-form-item class="input" label="账户状态">
                        ...
                        <!--
                            <el-form-item label="创建时间 show1 show2 nameShow" class="input" v-if="tableName=='yonghu'">
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // }
                            // yonghu 中的 用户介绍 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuContent== null ||this.ruleForm.yonghuContent== "")){
                            ...
                            //     return
                            // }
                            // yonghu 中的 创建时间 show1 show2 nameShow 判空处理
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/biji/img/back-img-bg.jpg);
